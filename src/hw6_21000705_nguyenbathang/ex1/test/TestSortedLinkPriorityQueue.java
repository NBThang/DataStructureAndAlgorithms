...
import hw6_21000705_nguyenbathang.ex1.sortedlinkpriorityqueue.SortedLinkPriorityQueue;

public class TestSortedLinkPriorityQueue {
    public static void main(String[] args) {
        SortedLinkPriorityQueue<Integer, Integer> priorityQueue = new SortedLinkPriorityQueue<>();
        ...
        SortedLinkPriorityQueue<Integer, String> priorityQueue2 = new SortedLinkPriorityQueue<>();
