...
import hw6_21000705_nguyenbathang.ex1.unsortedarraypriorityqueue.UnsortedArrayPriorityQueue;

public class TestUnsortedArrayPriorityQueue {
    public static void main(String[] args) {
        UnsortedArrayPriorityQueue<Integer, Integer> priorityQueue = new UnsortedArrayPriorityQueue<>();
        ...
        UnsortedArrayPriorityQueue priorityQueue2 = new UnsortedArrayPriorityQueue<>();
